      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '40px 24px' }}>
        ...
        <section style={{ maxWidth: '1200px', width: '100%', marginBottom: '120px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '24px' }}>
            ...
            {/* Bento Box 1: KPI Dashboard */}
            <div style={{
              background: '#111', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '24px', padding: '40px',
              gridColumn: '1 / -1'
            }}>
              <h3 style={{ fontSize: '24px', fontWeight: 700, color: '#fff', marginBottom: '16px' }}>Real-Time Performance Overview</h3>
              <p style={{ color: '#9ca3af', fontSize: '16px', marginBottom: '40px', maxWidth: '600px' }}>
                Every signal generated by the Alpha engine is permanently recorded and tracked against live market data. Our ledger is your proof of edge.
              </p>
              <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap' }}>
                <div style={{ flex: 1, minWidth: '200px', background: '#000', padding: '24px', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.05)' }}>
                  <div style={{ fontSize: '13px', color: '#9ca3af', marginBottom: '8px', fontWeight: 600 }}>WIN RATE (30D)</div>
                  <div style={{ fontSize: '40px', fontWeight: 800, color: '#4ade80' }}>71.4%</div>
                </div>
                <div style={{ flex: 1, minWidth: '200px', background: '#000', padding: '24px', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.05)' }}>
                  <div style={{ fontSize: '13px', color: '#9ca3af', marginBottom: '8px', fontWeight: 600 }}>NET R-MULTIPLE</div>
                  <div style={{ fontSize: '40px', fontWeight: 800, color: '#38bdf8' }}>+32.5R</div>
                </div>
                <div style={{ flex: 1, minWidth: '200px', background: '#000', padding: '24px', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.05)' }}>
                  <div style={{ fontSize: '13px', color: '#9ca3af', marginBottom: '8px', fontWeight: 600 }}>EXPECTANCY</div>
                  <div style={{ fontSize: '40px', fontWeight: 800, color: '#a855f7' }}>+0.7R</div>
                </div>
              </div>
            </div>

            {/* Bento Box 2: Deterministic Math */}
            <div style={{ background: '#111', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '24px', padding: '40px' }}>
              ...
              <h3 style={{ fontSize: '24px', fontWeight: 700, color: '#fff', marginBottom: '16px' }}>Deterministic Math</h3>
              <p style={{ color: '#9ca3af', fontSize: '16px', lineHeight: 1.6 }}>
                The Feature Engine processes raw tick data, applying institutional EMAs and momentum oscillators to mathematically define the market regime.
              </p>
            </div>

            {/* Bento Box 3: AI Risk Evaluation */}
            <div style={{ background: '#111', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '24px', padding: '40px' }}>
              ...
              <h3 style={{ fontSize: '24px', fontWeight: 700, color: '#fff', marginBottom: '16px' }}>AI Risk Evaluation</h3>
              <p style={{ color: '#9ca3af', fontSize: '16px', lineHeight: 1.6 }}>
                A specialized LLM acting as Senior Risk Officer evaluates structural alignment and strict R/R ratios, rejecting subpar setups instantly.
              </p>
            </div>
